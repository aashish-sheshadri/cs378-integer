...
OI divides_digits (II1 b1, II1 e1, II2 b2, II2 e2, OI x) {
    ...
    while(true){
        ...
        for(deque<int>::iterator it = runningSum.begin();it!=rsEnd;++it)
            std::cout<<*it<<" ";
        std::cout<<std::endl;
        if(std::lexicographical_compare(dividendRev.begin(),dividendRev.end(),num4Rev.begin(),num4Rev.end(),myCompare)){
            if(std::lexicographical_compare(dividendRev.begin(),dividendRev.end(),num8Rev.begin(),num8Rev.end(),myCompare)){
            ...
            if(std::lexicographical_compare(dividendRev.begin(),dividendRev.end(),num2Rev.begin(),num2Rev.end(),myCompare)){       
                ...
                rsEnd = plus_digits(runningSum.begin(),rsEnd,partialQ.begin(),partialQEnd,runningSum.begin());
                select = 2;
            } else if(std::lexicographical_compare(dividendRev.begin(),dividendRev.end(),numRev.begin(),numRev.end(),myCompare)) {
